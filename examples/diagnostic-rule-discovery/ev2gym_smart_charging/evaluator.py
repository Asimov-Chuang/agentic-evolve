"""EV2Gym smart charging diagnostic rule discovery evaluator."""
...
_base = _import_base()
strip_policy_visible_ev2gym = _base.strip_policy_visible_ev2gym
FORBIDDEN_EV2GYM_ROOT_KEYS = _base.FORBIDDEN_EV2GYM_ROOT_KEYS
...
def _evaluate_core(program_path: str, output_dir: str, workspace: Path) -> dict:
    return _base.evaluate_core(
        ...
        output_dir,
        workspace,
        strip_fn=strip_policy_visible_ev2gym,
        extra_forbidden=FORBIDDEN_EV2GYM_ROOT_KEYS,
    )
