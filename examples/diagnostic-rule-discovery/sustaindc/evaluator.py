"""SustainDC diagnostic rule discovery evaluator."""
...
# Resolve _shared from task tree or copied workspace/_shared
def _import_base():
    candidates = [
...
_base = _import_base()
strip_policy_visible_sustaindc = _base.strip_policy_visible_sustaindc
...
def _evaluate_core(program_path: str, output_dir: str, workspace: Path) -> dict:
    return _base.evaluate_core(
        ...
        output_dir,
        workspace,
        strip_fn=strip_policy_visible_sustaindc,
    )
