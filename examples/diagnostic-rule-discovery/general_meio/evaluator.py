"""general_meio diagnostic rule discovery evaluator."""
...
_base = _import_base()
strip_policy_visible_general_meio = _base.strip_policy_visible_general_meio
...
def _evaluate_core(program_path: str, output_dir: str, workspace: Path) -> dict:
    return _base.evaluate_core(
        ...
        output_dir,
        workspace,
        strip_fn=strip_policy_visible_general_meio,
    )
