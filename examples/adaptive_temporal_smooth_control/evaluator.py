"""Adaptive temporal smooth control evaluator for agentic-evolve (Frontier subprocess bridge)."""
...
def _resolve_paths() -> tuple[Path, Path, Path]:
    ...
    benchmark_dir = frontier_root / "benchmarks" / "Optics" / "adaptive_temporal_smooth_control"
